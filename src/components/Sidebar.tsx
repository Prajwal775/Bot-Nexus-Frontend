...
//             <h1 className="text-white text-base font-bold leading-none">BotNexus</h1>
//             <p className="text-[#ab9db9] text-[10px] uppercase tracking-widest font-semibold">Enterprise AI</p>
//           </div>
//         </div>
...
//               (location.pathname.startsWith('/chat-logs') && item.path === '/chat-logs') ||
//               (location.pathname.startsWith('/knowledge-base') && item.path === '/knowledge-base');
...
//           <p className="text-xs font-bold uppercase tracking-wider text-[#ab9db9] mb-2">Usage</p>
